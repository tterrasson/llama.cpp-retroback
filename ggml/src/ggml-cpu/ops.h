...
void ggml_compute_forward_conv_rs_gather(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_fused_sparse_ce(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_fused_sparse_ce_back(const struct ggml_compute_params * params, struct ggml_tensor * dst);
