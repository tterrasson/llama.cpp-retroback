...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_ssm_scan_back     (ggml_metal_library_t lib, const struct ggml_tensor * op); // retro delta
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_silu_back         (ggml_metal_library_t lib, const struct ggml_tensor * op); // retro delta
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_get_rows_back     (ggml_metal_library_t lib, const struct ggml_tensor * op); // retro delta
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_retro_fill        (ggml_metal_library_t lib); // retro delta: flat F32 fill helper
