...
int ggml_metal_op_gated_delta_net_back(ggml_metal_op_t ctx, int idx); // retro delta
...
int ggml_metal_op_silu_back         (ggml_metal_op_t ctx, int idx); // retro delta
...
int ggml_metal_op_get_rows_back     (ggml_metal_op_t ctx, int idx); // retro delta
